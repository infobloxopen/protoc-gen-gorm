...
func (TestTypesStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{0, 0}
}
...
func (*TestTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{0}
}
...
func (*TypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{1}
}
...
func (*MultiaccountTypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{2}
}
...
func (*MultiaccountTypeWithoutID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{3}
}
...
func (*APIOnlyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{4}
}
...
func (*PrimaryUUIDType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{5}
}
...
func (*PrimaryStringType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{6}
}
...
func (*TestTag) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{7}
}
...
func (*TestTagAssociation) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{8}
}
...
func (*PrimaryIncluded) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_ac24f32101a01d20, []int{9}
}
...
func init() {
	proto.RegisterFile("example/feature_demo/demo_types.proto", fileDescriptor_demo_types_ac24f32101a01d20)
}

var fileDescriptor_demo_types_ac24f32101a01d20 = []byte{
