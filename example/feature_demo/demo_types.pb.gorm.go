...
type TestAssocHandlerDefaultORM struct {
	Id               string
	TestReplaceAssoc []*TestTagAssociationORM `gorm:"foreignkey:TestAssocHandlerDefaultId;association_foreignkey:Id;preload:false"`
}
...
func (m *TestAssocHandlerDefault) ToORM(ctx context.Context) (TestAssocHandlerDefaultORM, error) {
	...
	to.Id = m.Id
	for _, v := range m.TestReplaceAssoc {
		if v != nil {
			if tempTestReplaceAssoc, cErr := v.ToORM(ctx); cErr == nil {
				to.TestReplaceAssoc = append(to.TestReplaceAssoc, &tempTestReplaceAssoc)
			} else {
				return to, cErr
			}
		} else {
			to.TestReplaceAssoc = append(to.TestReplaceAssoc, nil)
		}
	}
...
func (m *TestAssocHandlerDefaultORM) ToPB(ctx context.Context) (TestAssocHandlerDefault, error) {
	...
	for _, v := range m.TestReplaceAssoc {
		if v != nil {
			if tempTestReplaceAssoc, cErr := v.ToPB(ctx); cErr == nil {
				to.TestReplaceAssoc = append(to.TestReplaceAssoc, &tempTestReplaceAssoc)
			} else {
				return to, cErr
			}
...
type TestAssocHandlerReplaceORM struct {
	Id               string
	TestReplaceAssoc []*TestTagAssociationORM `gorm:"foreignkey:TestAssocHandlerReplaceId;association_foreignkey:Id;preload:false;replace:true"`
}
...
type TestAssocHandlerClearORM struct {
	Id               string
	TestReplaceAssoc []*TestTagAssociationORM `gorm:"foreignkey:TestAssocHandlerClearId;association_foreignkey:Id;preload:false;clear:true"`
}
...
type TestAssocHandlerAppendORM struct {
	Id               string
	TestReplaceAssoc []*TestTagAssociationORM `gorm:"foreignkey:TestAssocHandlerAppendId;association_foreignkey:Id;preload:false;append:true"`
}
...
func DefaultStrictUpdateTypeWithID(ctx context.Context, in *TypeWithID, db *gorm1.DB) (*TypeWithID, error) {
	...
	if err = db.Model(&ormObj).Association("ANestedObject").Replace(ormObj.ANestedObject).Error; err != nil {
		return nil, err
	}
	ormObj.ANestedObject = nil
	if err = db.Model(&ormObj).Association("Things").Replace(ormObj.Things).Error; err != nil {
		return nil, err
	}
	ormObj.Things = nil
...
func DefaultStrictUpdatePrimaryUUIDType(ctx context.Context, in *PrimaryUUIDType, db *gorm1.DB) (*PrimaryUUIDType, error) {
	...
	if err = db.Model(&ormObj).Association("Child").Replace(ormObj.Child).Error; err != nil {
		return nil, err
	}
	ormObj.Child = nil
...
func DefaultStrictUpdateTestAssocHandlerDefault(ctx context.Context, in *TestAssocHandlerDefault, db *gorm1.DB) (*TestAssocHandlerDefault, error) {
	...
	if err = db.Model(&ormObj).Association("TestReplaceAssoc").Replace(ormObj.TestReplaceAssoc).Error; err != nil {
		return nil, err
	}
	ormObj.TestReplaceAssoc = nil
...
func DefaultApplyFieldMaskTestAssocHandlerDefault(ctx context.Context, patchee *TestAssocHandlerDefault, patcher *TestAssocHandlerDefault, updateMask *field_mask1.FieldMask, prefix string, db *gorm1.DB) (*TestAssocHandlerDefault, error) {
	...
	for _, f := range updateMask.Paths {
		...
		if f == prefix+"TestReplaceAssoc" {
			patchee.TestReplaceAssoc = patcher.TestReplaceAssoc
			continue
		}
	}
	if err != nil {
...
func DefaultStrictUpdateTestAssocHandlerClear(ctx context.Context, in *TestAssocHandlerClear, db *gorm1.DB) (*TestAssocHandlerClear, error) {
	...
	if err = db.Model(&ormObj).Association("TestReplaceAssoc").Clear().Error; err != nil {
		return nil, err
	}
	ormObj.TestReplaceAssoc = nil
...
func DefaultStrictUpdateTestAssocHandlerAppend(ctx context.Context, in *TestAssocHandlerAppend, db *gorm1.DB) (*TestAssocHandlerAppend, error) {
	...
	if err = db.Model(&ormObj).Association("TestReplaceAssoc").Append(ormObj.TestReplaceAssoc).Error; err != nil {
		return nil, err
	}
	ormObj.TestReplaceAssoc = nil
