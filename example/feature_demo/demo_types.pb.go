...
func (TestTypesStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{0, 0}
}
...
func (*TestTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{0}
}
...
func (*TypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{1}
}
...
func (*MultiaccountTypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{2}
}
...
func (*MultiaccountTypeWithoutID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{3}
}
...
func (*APIOnlyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{4}
}
...
func (*PrimaryUUIDType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{5}
}
...
func (*PrimaryStringType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{6}
}
...
func (*PrimaryIncluded) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_a14693065bb71bdc, []int{7}
}
...
func init() {
	proto.RegisterFile("example/feature_demo/demo_types.proto", fileDescriptor_demo_types_a14693065bb71bdc)
}

var fileDescriptor_demo_types_a14693065bb71bdc = []byte{
