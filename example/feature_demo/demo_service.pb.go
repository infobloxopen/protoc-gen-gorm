...
func (c *multipleMethodsAutoGenClient) CreateC(ctx context.Context, in *CreateIntPointRequest, opts ...grpc.CallOption) (*CreateIntPointResponse, error) {
	out := new(CreateIntPointResponse)
	err := grpc.Invoke(ctx, "/example.MultipleMethodsAutoGen/CreateC", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MultipleMethodsAutoGen_CreateC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateIntPointRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultipleMethodsAutoGenServer).CreateC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.MultipleMethodsAutoGen/CreateC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultipleMethodsAutoGenServer).CreateC(ctx, req.(*CreateIntPointRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MultipleMethodsAutoGen_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateC",
			Handler:    _MultipleMethodsAutoGen_CreateC_Handler,
		},
		{
			MethodName: "ReadA",
...
var fileDescriptor2 = []byte{
	...
	0x18, 0xc6, 0x49, 0x30, 0xf0, 0xa6, 0x49, 0xda, 0x93, 0x8f, 0x11, 0xb7, 0xcb, 0x32, 0xdf, 0xb4,
	...
	0x25, 0xda, 0xd5, 0x7e, 0xc9, 0x7e, 0xc8, 0x2e, 0xa6, 0xe3, 0x73, 0xec, 0x18, 0x63, 0xba, 0x76,
	...
	,
}
