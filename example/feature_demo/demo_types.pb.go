...
func (TestTypesStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{0, 0}
}
...
func (*TestTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{0}
}
...
func (*TypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{1}
}
...
func (*MultiaccountTypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{2}
}
...
func (*MultiaccountTypeWithoutID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{3}
}
...
func (*APIOnlyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_c0a1a299aecdefaa, []int{4}
}
...
func init() {
	proto.RegisterFile("example/feature_demo/demo_types.proto", fileDescriptor_demo_types_c0a1a299aecdefaa)
}

var fileDescriptor_demo_types_c0a1a299aecdefaa = []byte{
