...
func (*ReadAccountRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ReadBlogPostsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func init() { proto.RegisterFile("feature_demo/demo_multi_file_service.proto", fileDescriptor0) }
