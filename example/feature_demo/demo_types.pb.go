...
func (TestTypesStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{0, 0}
}
...
func (*TestTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{0}
}
...
func (*TypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{1}
}
...
func (*MultiaccountTypeWithID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{2}
}
...
func (*MultiaccountTypeWithoutID) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{3}
}
...
func (*APIOnlyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{4}
}
...
func (*PrimaryUUIDType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{5}
}
...
func (*PrimaryStringType) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{6}
}
...
func (*PrimaryIncluded) Descriptor() ([]byte, []int) {
	return fileDescriptor_demo_types_6ed44d129f65a465, []int{7}
}
...
func init() {
	proto.RegisterFile("example/feature_demo/demo_types.proto", fileDescriptor_demo_types_6ed44d129f65a465)
}

var fileDescriptor_demo_types_6ed44d129f65a465 = []byte{
