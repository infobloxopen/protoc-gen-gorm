...
type TestTypesORM struct {
	ANestedObjectTypeWithIDId *uint32 // of TypeWithID
	BecomesInt                int32
	CreatedAt                 time.Time
	JsonField                 *gormpq.Jsonb
	NullableUuid              *uuid.UUID
	OptionalString            *string
	ThingsTypeWithIDId        *uint32 // of TypeWithID
	TypeWithIdId              uint32
	Uuid                      uuid.UUID
}
...
type TypeWithIDORM struct {
	...
	Id            uint32               // of TypeWithID
	IntPointId    *uint32              // of IntPoint
...
type MultiaccountTypeWithIDORM struct {
	AccountID string
	Id        uint64 // of MultiaccountTypeWithID
	SomeField string
}
