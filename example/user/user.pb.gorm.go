...
import _ "github.com/infobloxopen/atlas-app-toolkit/rpc/resource/resourcepb"
...
type UserORM struct {
	...
	BillingAddressId  resource.Identifier
	Birthday          time.Time
	CreatedAt         time.Time
	...
	ShippingAddressId resource.Identifier
...
func (m *User) ToORM(ctx context.Context) (UserORM, error) {
	...
	if v, err := resource.Decode(m, m.Id); err != nil {
		return to, err
	} else {
		to.Id = v
	}
...
func (m *UserORM) ToPB(ctx context.Context) (User, error) {
	...
	if v, err := resource.Encode(m, m.Id); err != nil {
		return to, err
	} else {
		to.Id = v
	}
