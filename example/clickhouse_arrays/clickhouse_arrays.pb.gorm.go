...
type ExampleORM struct {
	ArrayOfBools   pq.BoolArray    `gorm:"type:Array(Bool)"`
	ArrayOfFloat64 pq.Float64Array `gorm:"type:Array(Double)"`
	ArrayOfInt64   pq.Int64Array   `gorm:"type:Array(Int64)"`
	ArrayOfString  pq.StringArray  `gorm:"type:Array(String)"`
	Description    string
