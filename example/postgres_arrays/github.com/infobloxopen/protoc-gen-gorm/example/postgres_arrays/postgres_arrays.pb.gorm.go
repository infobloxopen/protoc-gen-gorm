...
func (m *Example) ToORM(ctx context.Context) (ExampleORM, error) {
	...
	// Repeated type bool is not an ORMable message type
	// Repeated type double is not an ORMable message type
	// Repeated type int64 is not an ORMable message type
