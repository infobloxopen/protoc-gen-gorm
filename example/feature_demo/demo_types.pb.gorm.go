...
type TypeWithIDORM struct {
	...
	secret_int    int32           `gorm:"-;"`
	Things        []*TestTypesORM `gorm:"foreignkey:TypeWithIDId;association_foreignkey:Id;"`
	ANestedObject *TestTypesORM   `gorm:"foreignkey:TypeWithIDId;association_foreignkey:Id;"`
}
...
func DefaultStrictUpdateTypeWithID(ctx context.Context, in *TypeWithID, db *gorm.DB) (*TypeWithID, error) {
	...
	filterThings.TypeWithIDId = ormObj.Id
	...
	filterANestedObject.TypeWithIDId = ormObj.Id
