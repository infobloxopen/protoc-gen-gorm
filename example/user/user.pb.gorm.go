...
type UserORM struct {
	...
	BillingAddressId  *resource.Identifier // of Address
	Birthday          time.Time
	CreatedAt         time.Time
	...
	Id                *resource.Identifier // of User
	...
	ShippingAddressId *resource.Identifier // of Address
...
type EmailORM struct {
	AccountID  string
	Email      string
	Id         *resource.Identifier // of Email
	Subscribed bool
	UserId     *resource.Identifier // of User
}
...
type AddressORM struct {
	...
	Id        *resource.Identifier // of Address
	Post      string
}
...
type LanguageORM struct {
	AccountID string
	Code      string
	Id        *resource.Identifier // of Language
	Name      string
}
...
type CreditCardORM struct {
	AccountID string
	CreatedAt time.Time
	Id        *resource.Identifier // of CreditCard
	Number    string
	UpdatedAt time.Time
	UserId    *resource.Identifier // of User
}
...
type TaskORM struct {
	...
	Name        string
	Priority    int64
	UserId      resource.Identifier `gorm:"not null"` // of User
}
...
func DefaultDeleteUser(ctx context.Context, in *User, db *gorm.DB) error {
	...
	if ormObj.Id == nil || *ormObj.Id == resource.Nil {
...
func DefaultStrictUpdateUser(ctx context.Context, in *User, db *gorm.DB) (*User, error) {
	...
	filterCreditCard.UserId = new(resource.Identifier)
	*filterCreditCard.UserId = *ormObj.Id
	...
	filterEmails.UserId = new(resource.Identifier)
