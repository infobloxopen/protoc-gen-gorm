...
- GORM [tags](http://gorm.io/docs/models.html#Supported-Struct-tags) copied from
...
if don't exist in proto messages, their names correspond to GORM [default](http://gorm.io/docs/belongs_to.html) foreign key names.
